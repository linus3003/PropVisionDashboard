    ...
    html.Div(
        ...
        children=[     
            ...
            html.Div(
                ...
                style={'padding-top': 15,'padding-bottom': 10, 'margin-left': 40, 'width': '100%' },
                className='row',
...
def update_figure(selected_year, price,rel_price, size, diff):
    ...
    fig = px.scatter_mapbox(filtered_df, lat="latitude", lon="longitude", color='Eur/m²', hover_name="url", size=filtered_df['scale'],
                                    size_max=16, hover_data={
                                        "latitude": False, "longitude":False, "scale": False,
                                        "price":True, "sqft": True, "Eur/m²": True,"dev_status": True,
                                        },
